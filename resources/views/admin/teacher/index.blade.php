...
@section('teacher_open') opened @endsection
@section('teacher_index') menu-active @endsection
                    ...
                    <div class="tbl-row">
                        <div class="tbl-cell">
                            <div class="tbl tbl-item">
                                <div class="tbl-row">
                                    <div class="tbl-cell">
                                        <div class="title">จำนวนการสอนทั้งหมด</div>
                                        <div class="amount color-blue">{{$tech_all_count}}</div>
                        ...
                        <div class="tbl-cell">
                            <div class="tbl tbl-item">
                                <div class="tbl-row">
                                    <div class="tbl-cell">
                                        <div class="title">จำนวนการเรียนวันนี้</div>
                                        <div class="amount">{{$tech_today_count}}</div>
                                        <div class="amount-sm">จากทั้งหมด {{$teacher_today_count}}</div>
                                    </div>
                                    <div class="tbl-cell tbl-cell-progress">
                                        <div class="circle-progress-bar-typical size-56 pieProgress"
				...
				<header class="box-typical-header">
					<div class="tbl-row">
						<div class="tbl-cell tbl-cell-title">
							 <span><h3>ตารางครู</h3> <span class="pull-right" style="margin-top:-30px;padding-right: 20px;">{{ $datas->links() }} <a href="{{url('es4p/user/create')}}" class="btn btn-success btn-sm pull-right"><span class="lbl fw300">เพิ่ม ครู</span></a></span></span>
						</div>
					</div>
				</header>
						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th style="text-align: center;">จำนวนที่สอน</th>
							...
							<tbody>
								...
								<tr>
									...
									<td style="text-align: center;">
										...
										<span style="color: #fb6067;">{{$data->id}}</span>

									</td>
									<td style="text-align: center;">
										<!-- <div class="font-11 color-blue-grey-lighter uppercase"></div> -->
										<?php 
                                            if(!($data == '' || $data == NULL)) {
                                            echo $class_total = \DB::table('user_bookings')->where('teacher_id',$data->id)->count();
                                            }else {
									...
									<td style="text-align: center;">
										<a href="{{url('es4p/teacher/'.$data->id.'/edit')}}" class="btn btn-info btn-sm fw300">แก้ไข</a>
