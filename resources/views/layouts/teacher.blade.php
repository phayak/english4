...
<head>
    ...
    <title>english4speak Teacher</title>
...
<body class="with-side-menu">
    <header class="site-header">
        <div class="container-fluid">
            <a href="#" class="site-logo">
                ...
                <img class="hidden-lg-up" src="{{asset('assets/img/eng200.png')}}" height="35" width="auto" alt="">
            </a>
    ...
    @include('layouts.slide-menu-teacher', ['some' => 'data'])
    @yield('content')
