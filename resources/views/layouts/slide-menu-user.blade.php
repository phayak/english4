    ...
    <ul class="side-menu-list">
        ...
        <li class="green with-sub @yield('addclass')">
            <span>
                ...
                <span class="lbl">Add Class</span>
            </span>
            <ul style="@yield('addclass_ul')">
                <li><a href="{{url('teacher/addclass')}}"><span class="lbl">Index</span></a></li>
                <li style="background-color: #ddd;"><a href="{{url('teacher/addclass/create')}}"><span class="lbl">Create</span></a></li>
            </ul>
        </li>
