...
<div class="container bg-fff profile">
    <div class="col-md-12" style="margin-top:40px;"></div>
        <div class="col-md-2">   
            <div class="row">   
                ...
                <ul class="nav nav-pills nav-stacked" style="padding-right:7px;" role="tablist">
                    ...
                    <li class="kanit f18 fw300 nav-c active"><a href="{{url('/profile/msg/class')}}">ข้อความจากครู</a></li>  
        ...
        <div class="col-md-10" style="border-left: 2px solid #F1F0F0;" >
            <div class="row">
                <div class="col-md-9">
                    <h3 class="kanit nav-c">ข้อความจากครู <span class="badge f20">{{$commentCount}}</span></h3>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <span class="pull-right">{{ $comment->links() }}</span>
                            </div> <!-- col-md-6 -->
                        </div> <!-- row -->
                        <div class="row">
