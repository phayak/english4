...
class MsgClassController extends Controller
{
	public function __construct()
    {
        $this->middleware('auth');
    }
    public function msgclass(Request $request)
    {
        $user = Auth::User();
        ...
        return view('user.profile.msg',compact('user','packageNow','userBookingCount','userTrialClass','intWorkDay','userBookingofmonth','commentCount','comment','packageCount','userMakeup','userTrial','package_exp','intHoliday'));
    }
}
